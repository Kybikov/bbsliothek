...
-- blob_inhalt und checksumme_sha256 wurden entfernt:
-- Alle Dateien werden im Dateisystem gespeichert (einfacherer Ansatz)
-- speicherstrategie wird aus Kompatibilität mit der Aufgabenstellung behalten
